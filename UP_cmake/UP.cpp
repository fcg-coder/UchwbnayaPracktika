...
int det(int n1, int n2, int n3, int n4) {
    //Н = (А + В) / (C * C)
    int det = 0;
    // _asm
    // {
    ...
    //     mov eax, 0; //eax = 0
    //     mov eax, n1; //eax = n1
    //     cdq; // Расширение для знаковых чисел
    //     mov ebx, n4; // ebx = n4
    //     mul ebx; //eax = eax * ebx = n1 * n4;
    //     mov edx, eax; // edx = n1 * n4;
